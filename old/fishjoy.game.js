(function() {
    ...
    a.startup = function() {
        ...
        this.loader = null;
        if (Q.isWebKit && !Q.supportTouch) document.body.style.webkitTouchCallout = "none",
    ...
    a.initUI = function() {
        ...
        this.fishContainer.onEvent = function(b) {
            if (b.type == a.events[0] && a.fireCount >= a.fireInterval) a.fireCount = 0,
            a.player.fire({
                x: b.eventX,
                y: b.eventY
            })
    ...
    a.testFish = function() {
        for (var a = this.params.num || 50,
        e = c.R.fishTypes.length,
        d = 0; d < a; d++) {
    ...
    b.prototype.update = function() {
        for (var e = 0; e < this.fishes.length; e++) {
            var b = this.fishes[e];
            if (b.captured) this.fishes.splice(e, 1),
            e--;
            else if (b.isOutOfScreen()) {
                if (b.hasShown || b.changeDirCounter < -a.fps * 10) this.fishes.splice(e, 1),
    ...
    c.setRandomPatten = function(a, b, e) {
        var d = this.pattens; (0, d[Math.random() * d.length >> 0])(a, b, e)
    };
...
})(); (function() { (Q.use("fish").Utils = {}).calcDirection = function(c, a) {
        var b;
    ...
    c.prototype.setValue = function(a) {
        ...
        for (e = b.length - 1; a >= 0; a--) {
            ...
            c = e >= 0; (d.visible = c) && d.setRect(this.src[b.charAt(e)]);
            e--
        }
    }
})(); (function() {
    ...
    b.prototype.changeDirection = function(b) {
        ...
        else if (Math.random() > 0.8) b = Math.random() > 0.5 ? 1 : -1,
    ...
    b.prototype.update = function() {
        ...
        } else this.moving && (this.x += this.speedX, this.y += this.speedY),
    ...
    b.prototype.checkCollision = function() {
        for (var b = a.fishManager.fishes,
        d = b.length,
        h = !1,
        i = 0; i < d; i++) {
            var g = b[i];
        ...
        for (i = 0; i < d; i++) if (g = b[i], !(f.y - f.height * 0.5 > g.y + g.height * 0.5 || f.y + f.height * 0.5 < g.y - g.height * 0.5 || f.x - f.width * 0.5 > g.x + g.width * 0.5 || f.x + f.width * 0.5 < g.x - g.width * 0.5) && f.hitTestObject(g, !0) && g.canBeCaptured(this.power - 1)) g.moving = !1,
        g.captured = !0,
